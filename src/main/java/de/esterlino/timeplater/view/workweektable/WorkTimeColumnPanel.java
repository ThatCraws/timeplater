...
public class WorkTimeColumnPanel extends JPanel implements Content {
    ...
    private final int WRONG_NUMBER_IN_TIME_FORMAT_ERROR = 69;
    ...
    public Object getContent() {
        ...
        try {
            startTimeString = padTimeStringWithLeadingZeroIfNecessary(startTimeString);
        ...
        try {
            endTimeString = padTimeStringWithLeadingZeroIfNecessary(endTimeString);
    ...
    private String padTimeStringWithLeadingZeroIfNecessary(String timeString) {
